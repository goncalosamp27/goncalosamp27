...
<header class="w-full -mt-2 md:px-12  py-8 fixed top-0 left-0 flex items-center justify-between z-4 bg-gradient-to-b from-black/50 to-black/0 z-[6]" in:fade={{ duration: 1500 }}>
